...
let stream = fs.createReadStream('characteristic_reviews.csv');
let csvData = [];
...
stream.on('data', function(data) {
  ...
  stream.pause();
    let insertQuery = 'INSERT INTO characteristic_reviews (id, characteristic_id, review_id, value) VALUES ?'
